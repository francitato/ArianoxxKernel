...
# G920F
if [ "$TARGET" = "G930F" ] ; then
	export KERNEL_CONFIG="arianoxx_defconfig_flat";
fi;

# G925F
if [ "$TARGET" = "G935F" ] ; then
	export KERNEL_CONFIG="arianoxx_defconfig_edge";
fi;
...
# system compiler
#export CROSS_COMPILE=/home/arianoxx-dev/aarch64-cortex_a53-linux-gnueabi/bin/aarch64-cortex_a53-linux-gnueabi-
export CROSS_COMPILE=/home/arianoxx-dev/aarch64-linux-android-4.9/bin/aarch64-linux-android-
# export CROSS_COMPILE=/home/arianoxx-dev/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
