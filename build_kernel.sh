...
zip -r Arianoxx-Kernel-$TARGET-8.0-Beta.zip .
tar -H ustar -c ${KERNELDIR}/output/$TARGET/boot.img > Arianoxx-Kernel-$TARGET-8.0-Beta.tar
md5sum -t Arianoxx-Kernel-$TARGET-8.0-Beta.tar >> Arianoxx-Kernel-$TARGET-8.0-Beta.tar
mv Arianoxx-Kernel-$TARGET-8.0-Beta.tar Arianoxx-Kernel-$TARGET-8.0-Beta.tar.md5
echo
echo "Done"
